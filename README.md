...
```
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# Обнаружена ошибка в тестирующем модуле. Сейчас в качестве  "double startAngle, double arcAngle" передаются углы в градусах, хотя предполагалось использовать радианы.
# Чуть позже всё будет исправлена. Пока что стоит убрать конвертацию из предыдущего метода.
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
